...
export const AgeingSummary0To5Slice = createSlice({
  name: 'ageingsummary0to5',
...
export const { } = AgeingSummary0To5Slice.actions;

export default AgeingSummary0To5Slice.reducer;
